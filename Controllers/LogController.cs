...
namespace webAdmin.Controllers
{
    ...
    public class LogController : ControllerBase
    {
        ...
        public IActionResult LoginLogDataList([Bind("draw,search_type,search_value,search_date,start,length,column_name,column_order")] LoginLogDataList login_log_data_list)
        {
            ...
            {
				string success_yn = "";
				if (item.success_yn == "Y")
                {
					success_yn = _localizer["Success"];
				} else if (item.success_yn == "N") {
                    success_yn = _localizer["Fail"];
				}
                
				data.Add(new
                {
                    pw_error_count = item.pw_error_count,
        ...
        public IActionResult AdminLogDataList([Bind("draw,search_type,search_value,search_date,start,length,column_name,column_order")] AdminLogDataList admin_log_data_list)
        {
            ...
            if (admin_log_data_list.search_type != null)
            {
                ...
                if (admin_log_data_list.search_type == "target_id")
                {
                    dbDataCount = _context.Admin_log.Where(x => x.target_id == admin_log_data_list.search_value
                        && x.regist_date >= Convert.ToDateTime(startDate)
                        && x.regist_date <= Convert.ToDateTime(endDate)
                    ).Count();

                    dbFilterData = _context.Admin_log.Where(x => x.target_id == admin_log_data_list.search_value
                        && x.regist_date >= Convert.ToDateTime(startDate)
                        && x.regist_date <= Convert.ToDateTime(endDate)
                    ).OrderBy($"{SortColumnName} {sortTypeStr}").Skip(start).Take(length).ToList();
            ...
            foreach (var item in dbFilterData)
            {
                ...
                if (String.IsNullOrEmpty(item.division) == true)
                {
...
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    division = _localizer[item.division];
                }

                if (String.IsNullOrEmpty(item.menu) == true)
                {
#pragma warning disable CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                    menu = item.menu;
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    menu = _localizer[item.menu];
                }

                if (String.IsNullOrEmpty(item.item) == true)
                {
#pragma warning disable CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                    itemStr = item.item;
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    itemStr = _localizer[item.item];
                }

                if (String.IsNullOrEmpty(item.item_sub) == true)
                {
#pragma warning disable CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
...
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    itemSub = _localizer[item.item_sub];
                }

                if (String.IsNullOrEmpty(item.before) == true)
                {
#pragma warning disable CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
...
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    itemBefore = _localizer[item.before];
                }

                if (String.IsNullOrEmpty(item.after) == true)
                {
#pragma warning disable CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
...
#pragma warning restore CS8600 // null 리터럴 또는 가능한 null 값을 null을 허용하지 않는 형식으로 변환하는 중입니다.
                ...
                {
                    itemAfter = _localizer[item.after];
                }
